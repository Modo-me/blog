...
<div style="display: flex; flex-wrap: wrap; gap: 16px;">
  ...
  <div style="flex: 0 0 calc(50% - 8px); box-sizing: border-box; min-width: 250px; padding: 16px; border: 1px solid var(--border-color, #eee); border-radius: 8px; display: flex; justify-content: space-between; align-items: center;">
    <div>
      <h3 style="margin-top: 0; margin-bottom: 8px;"><a href="https://mias.moe" target="_blank">Mias' Blog</a></h3>
      <p style="margin: 0; color: var(--text-muted, #666);">The inescapable lot of solitude.</p>
    </div>
    <img src="https://mias.moe/image/avatar.jpg" width="70" height="70" style="border-radius: 50%; object-fit: cover; margin-left: 12px; box-shadow: 0 0 0 6px rgba(128,128,128,0.2);" />
  </div>
